...
cursor.execute("INSERT INTO [dbo].[REGISTOR]([person],[registime]) VALUES ("+repr(PERSONGROUPID)+",CONVERT(DATETIME,SYSDATETIMEOFFSET() AT TIME ZONE 'China Standard Time'))"
)
